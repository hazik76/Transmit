...
import ru.planirui.transmit.utilits.AppVoicePlayer
...
class HolderVoiceMessage(view: View) : RecyclerView.ViewHolder(view), MessageHolder {
    ...
    private val chatReceivedBtnPlay: ImageView = view.chat_receive_btn_play
    private val chatReceivedBtnStop: ImageView = view.chat_receive_btn_stop
